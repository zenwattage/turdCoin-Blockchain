...
class Blockchain {
    ...
    mindPendingTransactions(miningRewardAddress) {
        /**
         * adding all pending transactions isn't possible in a real blockchain
         * because blocksize cannot increase by 1mb. The miner must pick which transaction to include
        */
